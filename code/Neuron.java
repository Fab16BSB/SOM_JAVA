 ...
 * Each node holds a reference data, its coordinates in the map,
...
public class Neuron {
  ...
  /** Reference data vector associated with this node. */
  private Weight w;
   ...
   *
   * @param f the reference data vector for this node
